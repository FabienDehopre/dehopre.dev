    ...
    <app-container cssClass="mt-9">
      <div class="max-w-2xl">
        ...
        <div class="mt-6 flex gap-6">
          <a aria-label="Follow me on X" class="group -m-1 p-1" href="https://x.com/FabienDehopre" rel="noopener noreferrer" target="_blank">
            <svg class="
          ...
          <a aria-label="Follow me on BlueSky" class="group -m-1 p-1" href="https://bsky.app/profile/dehopre.dev" rel="noopener noreferrer" target="_blank">
            <svg class="
              h-6 w-6 fill-zinc-500 transition
              group-hover:fill-zinc-600
              dark:fill-zinc-400 dark:group-hover:fill-zinc-300
          ...
          <!--<a aria-label="Follow me on Mastodon" class="group -m-1 p-1" href="https://mastodon.social/@ghostlyshade" rel="noopener noreferrer" target="_blank">
            <svg class="
              h-6 w-6 fill-zinc-500 transition
              group-hover:fill-zinc-600
              dark:fill-zinc-400 dark:group-hover:fill-zinc-300
          ...
          <!--<a aria-label="Follow me on Reddit" class="group -m-1 p-1" href="https://www.reddit.com/user/NoEar9399/" rel="noopener noreferrer" target="_blank">
            <svg class="
              h-6 w-6 fill-zinc-500 transition
              group-hover:fill-zinc-600
              dark:fill-zinc-400 dark:group-hover:fill-zinc-300
          ...
          <!--<a aria-label="Follow me on Facebook" class="group -m-1 p-1" href="https://www.facebook.com/ghostlyshade" rel="noopener noreferrer" target="_blank">
            <svg class="
              h-6 w-6 fill-zinc-500 transition
              group-hover:fill-zinc-600
              dark:fill-zinc-400 dark:group-hover:fill-zinc-300
          ...
          <a aria-label="Follow me on Instagram" class="group -m-1 p-1" href="https://www.instagram.com/gh0stlysh4d3/" rel="noopener noreferrer" target="_blank">
            <svg class="
              h-6 w-6 fill-zinc-500 transition
              group-hover:fill-zinc-600
              dark:fill-zinc-400 dark:group-hover:fill-zinc-300
          ...
          <a aria-label="Follow me on LinkedIn" class="group -m-1 p-1" href="https://www.linkedin.com/in/fabien1979/" rel="noopener noreferrer" target="_blank">
            <svg class="
              h-6 w-6 fill-zinc-500 transition
              group-hover:fill-zinc-600
              dark:fill-zinc-400 dark:group-hover:fill-zinc-300
          ...
          <a aria-label="Follow me on GitHub" class="group -m-1 p-1" href="https://github.com/FabienDehopre" rel="noopener noreferrer" target="_blank">
            <svg class="
              h-6 w-6 fill-zinc-500 transition
              group-hover:fill-zinc-600
              dark:fill-zinc-400 dark:group-hover:fill-zinc-300
